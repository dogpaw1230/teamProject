...
### 1. 기획의도
  ...
  1) 혼자 여행하는 사람들은 증가하는데, 다수의 여행 사이트는 최소 2명 이상부터 구매할 수 있는 여행 패키지를 주로 제공하고 있음
  2) 혼자 여행하기 때문에 여행 동행을 구하는 여행자들이 많은데, 최소한의 인적 정보를 알 수 없어 안전 문제가 생길 수 있음
  3) 대부분의 여행 사이트는 후기 게시판이 없어 실제 여행의 만족도나 장단점을 알 수 없음
<br>
